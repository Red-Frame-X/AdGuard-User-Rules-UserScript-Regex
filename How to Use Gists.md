...
2. ブラウザのアドレスバーでURLを確認します。通常は以下のようになっています。
   ```text
   [https://gist.githubusercontent.com/ユーザー名/GistID/raw/長い英数字の羅列/ファイル名.txt](https://gist.githubusercontent.com/ユーザー名/GistID/raw/長い英数字の羅列/ファイル名.txt)
   ```
3. URLから `長い英数字の羅列/` の部分を削除し、以下のような形式にします。
   ```text
   [https://gist.githubusercontent.com/ユーザー名/GistID/raw/ファイル名.txt](https://gist.githubusercontent.com/ユーザー名/GistID/raw/ファイル名.txt)
   ```
   > **💡 補足**
...
2. ブラウザのアドレスバーでURLを確認します。通常は以下のようになっています。
   ```text
   [https://gist.githubusercontent.com/ユーザー名/GistID/raw/長い英数字の羅列/ファイル名.user.js](https://gist.githubusercontent.com/ユーザー名/GistID/raw/長い英数字の羅列/ファイル名.user.js)
   ```
3. URLから `長い英数字の羅列/` の部分を削除し、以下のような形式にします。
   ```text
   [https://gist.githubusercontent.com/ユーザー名/GistID/raw/ファイル名.user.js](https://gist.githubusercontent.com/ユーザー名/GistID/raw/ファイル名.user.js)
   ```
   > **💡 補足**
